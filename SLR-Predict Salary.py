...
Simple linear regression example: fits Salary ~ YearsExperience on
Salary_Data.csv, visualizes the fit, and predicts a salary for a
user-supplied years-of-experience value.
"""
